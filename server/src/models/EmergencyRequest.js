...
const schema = new mongoose.Schema({
  ...
  emergencyType: { type: String, default: 'General' }, description: String, patientLocation: { type: { type: String, enum: ['Point'] }, coordinates: [Number] }, destinationLocation: { type: { type: String, enum: ['Point'] }, coordinates: [Number] },
